...
import { getBranchId, getBranchs, getTotalSoLuotKham } from '../../endpoint/user';
...
export const options = {
  ...
  plugins: {
    ...
    title: {
      display: true,
      text: 'Biều đồ thống kê số lượt khám theo tháng',
    },
  },
};
...
function ChartVisit() {
  ...
  useEffect(() => {
    ...
    getTotalSoLuotKham(dataQuery?.from, dataQuery?.to, branchId)
      .then((res) => {
